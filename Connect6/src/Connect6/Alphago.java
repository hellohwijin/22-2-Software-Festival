...
public class Alphago {
    ...
    public static void addSuperWeight() {
        ...
        for (int i = 0; i < 19; i++) {
            ...
            for (int j = 0; j < 19; j++) {
                try {
                    if (PlayBoard.playBoard[i][j] == PlayBoard.ComC) {
                        myCount++;
                        if (myCount == 5) {
                    ...
                    if (PlayBoard.playBoard[i][j] == PlayBoard.ComC) {
                        ...
                        if (myCount == 3) { // 세번연속일때
                            ...
                            if (j + 3 < 19 && PlayBoard.playBoard[i][j + 1] == 0
                                    && PlayBoard.playBoard[i][j + 2] == PlayBoard.ComC
                                ...
                                add += 2;
                                    ...
                                    && (PlayBoard.playBoard[i][j - 3] == 0
                                            && PlayBoard.playBoard[i][j - 4] == PlayBoard.ComC
                                ...
                                add += 2;
                                    ...
                                    && PlayBoard.playBoard[i][j + 2] == PlayBoard.ComC) { // 0[111]01 mid
                                superWeight[i][j - 3] += 40;
                    ...
                    if (PlayBoard.playBoard[i][j] == PlayBoard.ComC) {
                        ...
                        if (myCount == 3) { // 세번연속일때
                            ...
                            if (j + 3 < 19 && (PlayBoard.playBoard[i][j + 1] == 0 && PlayBoard.playBoard[i][j + 2] == 0
                                    && PlayBoard.playBoard[i][j + 3] == PlayBoard.ComC)) { // [111]001 right
                                ...
                                add += 2;
                                    ...
                                    && (PlayBoard.playBoard[i][j - 3] == 0 && PlayBoard.playBoard[i][j - 4] == 0
                                            && PlayBoard.playBoard[i][j - 5] == PlayBoard.ComC)) { // 100[111] left
                    ...
                    if (myCount == 2) {
                        ...
                        try {
                            ...
                            if (j + 4 < 19 && PlayBoard.playBoard[i][j + 1] == 0 && PlayBoard.playBoard[i][j + 2] == 0
                                    && PlayBoard.playBoard[i][j + 3] == PlayBoard.ComC
                                    && PlayBoard.playBoard[i][j + 4] == PlayBoard.ComC) { // [11]0011 right
                                superWeight[i][j + 1] += 40;
                                superWeight[i][j + 2] += 40;
                                add += 2;
                            } /*
                               ...
                               * PlayBoard.ComC && PlayBoard.playBoard[i][j - 5] == PlayBoard.ComC) { //
                               * 1100[11] left
                               * superWeight[i][j - 2] += 40; superWeight[i][j - 3] += 40; add += 2; }
                               */ else if (j - 2 > 0 && j + 3 > 19 && PlayBoard.playBoard[i][j - 2] == 0
                                    && PlayBoard.playBoard[i][j + 1] == 0
                                    && PlayBoard.playBoard[i][j + 2] == PlayBoard.ComC
                                    && PlayBoard.playBoard[i][j + 3] == PlayBoard.ComC) { // 0[11]011 mid
                                superWeight[i][j - 2] += 40;
                                superWeight[i][j + 1] += 40;
                                add += 2;
                            } /*
                               ...
                               * PlayBoard.UserC && PlayBoard.playBoard[i][j - 4] == PlayBoard.ComC) { //
                               * 0110[11] left
                               * superWeight[i][j - 2] += 40; superWeight[i][j - 5] += 40; add += 2; }
                               */ else if (j - 5 > 0 && PlayBoard.playBoard[i][j - 2] == 0
                                    && PlayBoard.playBoard[i][j - 4] == 0
                                    && PlayBoard.playBoard[i][j - 3] == PlayBoard.ComC
                                    && PlayBoard.playBoard[i][j - 5] == PlayBoard.ComC) { // 1010[11] left
                                superWeight[i][j - 2] += 40;
                                superWeight[i][j - 4] += 40;
                                add += 2;
                                    ...
                                    && PlayBoard.playBoard[i][j + 1] == 0
                                    && PlayBoard.playBoard[i][j - 3] == PlayBoard.ComC
                                    && PlayBoard.playBoard[i][j + 2] == PlayBoard.ComC) { // 10[11]01 mid
                                superWeight[i][j - 2] += 40;
                                superWeight[i][j + 1] += 40;
                                add += 2;
                                    ...
                                    && PlayBoard.playBoard[i][j + 3] == 0
                                    && PlayBoard.playBoard[i][j + 2] == PlayBoard.ComC
                                    && PlayBoard.playBoard[i][j + 4] == PlayBoard.ComC) { // [11]0101 right
                                superWeight[i][j + 3] += 40;
                                superWeight[i][j + 1] += 40;
                                add += 2;
                            } else if (j + 4 < 19 && PlayBoard.playBoard[i][j + 1] == 0
                                    && PlayBoard.playBoard[i][j + 4] == 0
                                    && PlayBoard.playBoard[i][j + 2] == PlayBoard.ComC
                                    && PlayBoard.playBoard[i][j + 3] == PlayBoard.ComC) { // [11]0110 right
                                superWeight[i][j + 4] += 40;
                                superWeight[i][j + 1] += 40;
                                add += 2;
                            } /*
                               ...
                               * PlayBoard.ComC && PlayBoard.playBoard[i][j - 4] == PlayBoard.ComC) { //
                               * 110[11]0 mid
                    ...
                    if (PlayBoard.playBoard[i][j] == PlayBoard.ComC) {
                        ...
                        if (myCount == 3) {
                            if (i + 3 < 19 && PlayBoard.playBoard[i + 1][j] == 0
                                    && PlayBoard.playBoard[i + 2][j] == PlayBoard.ComC
                                ...
                                add += 2;
                                    ...
                                    && PlayBoard.playBoard[i - 4][j] == PlayBoard.ComC
                    ...
                    if (PlayBoard.playBoard[i][j] == PlayBoard.ComC) {
                        ...
                        if (myCount == 3) {
                            if (i + 3 < 19 && PlayBoard.playBoard[i + 1][j] == 0 && PlayBoard.playBoard[i + 2][j] == 0
                                    && PlayBoard.playBoard[i + 3][j] == PlayBoard.ComC) { // [111]001 right
                                superWeight[i + 1][j] += 40;
                                superWeight[i + 2][j] += 40;
                                add += 2;
                            } else if (i - 5 > 0 && PlayBoard.playBoard[i - 3][j] == 0
                                    && PlayBoard.playBoard[i - 4][j] == 0
                                    && PlayBoard.playBoard[i - 5][j] == PlayBoard.ComC) {// 100[111] left
                                ...
                                add += 2;
                                    ...
                                    && PlayBoard.playBoard[i + 2][j] == PlayBoard.ComC) { // 0[111]01 mid
                                superWeight[i - 3][j] += 40;
                                superWeight[i + 2][j] += 40;
                                add += 2;
                    ...
                    if (PlayBoard.playBoard[i][j] == PlayBoard.ComC) {
                        ...
                        if (myCount == 2) {
                            if (i + 4 < 19 && PlayBoard.playBoard[i + 1][j] == 0 && PlayBoard.playBoard[i + 2][j] == 0
                                    && PlayBoard.playBoard[i + 3][j] == PlayBoard.ComC
                                    && PlayBoard.playBoard[i + 4][j] == PlayBoard.ComC) { // [11]0011 (right)
                                superWeight[i + 1][j] += 40;
                                superWeight[i + 2][j] += 40;
                                add += 2;
                            }
                             ...
                             * PlayBoard.ComC && PlayBoard.playBoard[i - 5][j] == PlayBoard.ComC) { //
                             * 1100[11] left
                             ...
                             */
                                    ...
                                    && PlayBoard.playBoard[i + 1][j] == 0
                                    && PlayBoard.playBoard[i + 2][j] == PlayBoard.ComC
                                    && PlayBoard.playBoard[i + 3][j] == PlayBoard.ComC) { // 0[11]011 (mid)
                                superWeight[i - 2][j] += 40;
                                superWeight[i + 1][j] += 40;
                                add += 2;
                            }
                             ...
                             * PlayBoard.ComC && PlayBoard.playBoard[i - 4][j] == PlayBoard.ComC) { //
                             * 0110[11] (left)
                             ...
                             */
                                    ...
                                    && PlayBoard.playBoard[i - 4][j] == 0
                                    && PlayBoard.playBoard[i - 3][j] == PlayBoard.ComC
                                    && PlayBoard.playBoard[i - 5][j] == PlayBoard.ComC) { // 1010[11] (left)
                                superWeight[i - 2][j] += 40;
                                superWeight[i - 4][j] += 40;
                                add += 2;
                            }
                                    ...
                                    && PlayBoard.playBoard[i + 1][j] == 0
                                    && PlayBoard.playBoard[i - 3][j] == PlayBoard.ComC
                                    && PlayBoard.playBoard[i + 2][j] == PlayBoard.ComC) { // 10[11]01 mid
                                superWeight[i - 2][j] += 40;
                                superWeight[i + 1][j] += 40;
                                add += 2;
                            }
                                    ...
                                    && PlayBoard.playBoard[i + 2][j] == PlayBoard.ComC
                                    && PlayBoard.playBoard[i + 4][j] == PlayBoard.ComC) { // [11]0101 (right)
                                superWeight[i + 3][j] += 40;
                                superWeight[i + 1][j] += 40;
                                add += 2;
                            }
                                    ...
                                    && PlayBoard.playBoard[i + 4][j] == 0
                                    && PlayBoard.playBoard[i + 2][j] == PlayBoard.ComC
                                    && PlayBoard.playBoard[i + 3][j] == PlayBoard.ComC) { // [11]0110 (right)
                                superWeight[i + 4][j] += 40;
                                superWeight[i + 1][j] += 40;
                                add += 2;
                            }
        ...
        for (int i = 0; i < 19; i++) {
            ...
            for (int j = 0; j < 19; j++) {
                ...
                for (int k = 0; k < 5; k++) {
                    try {
                        if (PlayBoard.playBoard[temp1][temp2] == PlayBoard.ComC) {
                            myCount++;
                            if (myCount == 5) {
                        ...
                        if (PlayBoard.playBoard[temp1][temp2] == PlayBoard.ComC) {
                            ...
                            if (myCount == 3) {
                                if ((temp1 + 3 <= 18 && temp2 + 3 <= 18)
                                        && PlayBoard.playBoard[temp1 + 1][temp2 + 1] == 0
                                        && PlayBoard.playBoard[temp1 + 2][temp2 + 2] == PlayBoard.ComC
                                    ...
                                    add++;
                                        ...
                                        && PlayBoard.playBoard[temp1 - 3][temp2 - 3] == 0
                                        && PlayBoard.playBoard[temp1 - 4][temp2 - 4] == PlayBoard.ComC
                                        && PlayBoard.playBoard[temp1 - 5][temp2 - 5] == 0) {
                                    superWeight[temp1 - 5][temp2 - 5] += 40;
                                    add++;
                                    superWeight[temp1 - 3][temp2 - 3] += 40;
                        ...
                        if (PlayBoard.playBoard[temp1][temp2] == PlayBoard.ComC) {
                            ...
                            if (myCount == 3) {
                                if ((temp1 + 3 <= 18 && temp2 + 3 <= 18)
                                        && PlayBoard.playBoard[temp1 + 1][temp2 + 1] == 0
                                        && PlayBoard.playBoard[temp1 + 2][temp2 + 2] == 0
                                        && PlayBoard.playBoard[temp1 + 3][temp2 + 3] == PlayBoard.ComC) {
                                    superWeight[temp1 + 1][temp2 + 1] += 40;
                                    add++;
                                    superWeight[temp1 + 2][temp2 + 2] += 40;
                                    add++;
                                        ...
                                        && PlayBoard.playBoard[temp1 - 3][temp2 - 3] == 0
                                        && PlayBoard.playBoard[temp1 - 4][temp2 - 4] == 0
                                        && PlayBoard.playBoard[temp1 - 5][temp2 - 5] == PlayBoard.ComC) {
                                    superWeight[temp1 - 4][temp2 - 4] += 40;
                                    add++;
                                    superWeight[temp1 - 3][temp2 - 3] += 40;
                                    add++;
        ...
        for (int i = 0; i < 19; i++) {
            ...
            for (int j = 0; j < 19; j++) {
                try {
                    if (PlayBoard.playBoard[i][j] == PlayBoard.UserC) {
                        myCount++;
                        if (myCount == 5) {
            ...
            for (int j = 0; j < 19; j++) {
                try {
                    if (PlayBoard.playBoard[i][j] == PlayBoard.UserC) {
                        ...
                        if (myCount == 3) { // 세번연속일때
                            // 111010
                            if (PlayBoard.playBoard[i][j + 1] == 0 && PlayBoard.playBoard[i][j + 2] == PlayBoard.UserC
                                    && PlayBoard.playBoard[i][j + 3] == 0) {
                            ...
                            // 010111
                            else if (PlayBoard.playBoard[i][j - 3] == 0
                                    && PlayBoard.playBoard[i][j - 4] == PlayBoard.UserC
                    ...
                    if (PlayBoard.playBoard[i][j] == PlayBoard.UserC) {
                        ...
                        if (myCount == 3) { // 세번연속일때
                            ...
                            if (PlayBoard.playBoard[i][j + 1] == 0 && PlayBoard.playBoard[i][j + 2] == 0
                                    && PlayBoard.playBoard[i][j + 3] == PlayBoard.UserC) {
                                if (weight[i][j + 2] > weight[i][j + 1]) {
                                    superWeight[i][j + 2] += 40;
                                    add++;
                                } else {
                            ...
                            // 100111
                                    ...
                                    && PlayBoard.playBoard[i][j - 5] == PlayBoard.UserC) {
                        ...
                        if (myCount == 2) {
                            if (PlayBoard.playBoard[i][j + 1] == 0 && PlayBoard.playBoard[i][j + 2] == 0
                                ...
                                add++;
                                    ...
                                    && PlayBoard.playBoard[i][j + 2] == PlayBoard.UserC
                                    && PlayBoard.playBoard[i][j + 3] == PlayBoard.UserC) {
                                superWeight[i][j - 2] += 40;
                                add++;
                                superWeight[i][j + 1] += 40;
            ...
            for (int i = 0; i < 19; i++) {
                try {
                    if (PlayBoard.playBoard[i][j] == PlayBoard.UserC) {
                        myCount++;
                        if (myCount == 3) {
                            if (PlayBoard.playBoard[i + 1][j] == 0 && PlayBoard.playBoard[i + 2][j] == PlayBoard.UserC
                                    && PlayBoard.playBoard[i + 3][j] == 0) {
                            ...
                            } else if (PlayBoard.playBoard[i - 3][j] == 0
                                    && PlayBoard.playBoard[i - 4][j] == PlayBoard.UserC
                    ...
                    if (PlayBoard.playBoard[i][j] == PlayBoard.UserC) {
                        ...
                        if (myCount == 3) {
                            if (PlayBoard.playBoard[i + 1][j] == 0 && PlayBoard.playBoard[i + 2][j] == 0
                                    && PlayBoard.playBoard[i + 3][j] == PlayBoard.UserC) {
                                if (weight[i + 2][j] > weight[i + 1][j]) {
                                    superWeight[i + 2][j] += 40;
                                    add++;
                                } else {
                                    ...
                                    && PlayBoard.playBoard[i - 5][j] == PlayBoard.UserC) {
                        ...
                        if (myCount == 2) {
                            if (PlayBoard.playBoard[i + 1][j] == 0 && PlayBoard.playBoard[i + 2][j] == 0
                                ...
                                add++;
                                    ...
                                    && PlayBoard.playBoard[i + 2][j] == PlayBoard.UserC
                                    && PlayBoard.playBoard[i + 3][j] == PlayBoard.UserC) {
                                superWeight[i - 2][j] += 40;
                                add++;
                                superWeight[i + 1][j] += 40;
        ...
        for (int i = 0; i < 19; i++) {
            ...
            for (int j = 0; j < 19; j++) {
                ...
                for (int k = 0; k < 5; k++) {
                    try {
                        if (PlayBoard.playBoard[temp1][temp2] == PlayBoard.UserC) {
                            myCount++;
                            if (myCount == 5) {
                                // 둘다뚫림
                                if ((temp1 - 5 < 0 || temp2 - 5 < 0)
                        ...
                        if (PlayBoard.playBoard[temp1][temp2] == PlayBoard.UserC) {
                            ...
                            if (myCount == 3) {
                                if (PlayBoard.playBoard[temp1 + 1][temp2 + 1] == 0
                                        && PlayBoard.playBoard[temp1 + 2][temp2 + 2] == PlayBoard.UserC
                                        && PlayBoard.playBoard[temp1 + 3][temp2 + 3] == 0) {
                                    if (weight[temp1 + 3][temp2 + 3] > weight[temp1 + 1][temp2 + 1]) {
                                        ...
                                        && PlayBoard.playBoard[temp1 - 4][temp2 - 4] == PlayBoard.UserC
                                        && PlayBoard.playBoard[temp1 - 5][temp2 - 5] == 0) {
                    ...
                    try {
                        if (PlayBoard.playBoard[temp1][temp2] == PlayBoard.UserC) {
                            ...
                            if (myCount == 3) {
                                if (PlayBoard.playBoard[temp1 + 1][temp2 + 1] == 0
                                        && PlayBoard.playBoard[temp1 + 2][temp2 + 2] == 0
                                        && PlayBoard.playBoard[temp1 + 3][temp2 + 3] == PlayBoard.UserC) {
                                    if (weight[temp1 + 1][temp2 + 1] > weight[temp1 + 2][temp2 + 2]) {
                                        superWeight[temp1 + 1][temp2 + 1] += 40;
                                        add++;
                                    } else {
                                        ...
                                        && PlayBoard.playBoard[temp1 - 4][temp2 - 4] == 0
                                        && PlayBoard.playBoard[temp1 - 5][temp2 - 5] == PlayBoard.UserC) {
                        ...
                        if (myCount == 3) { // 세번연속일때
                            ...
                            if (j + 3 < 19 && PlayBoard.playBoard[i][j + 1] == 0
                                ...
                                add += 2;
                                    ...
                                    && PlayBoard.playBoard[i][j + 1] == 0
                                    && PlayBoard.playBoard[i][j + 2] == PlayBoard.UserC) { // 0[111]01 mid
                                superWeight[i][j - 3] += 40;
                                superWeight[i][j + 2] += 40;
                                add += 2;
                            } else if (j - 4 > 0 && j + 1 < 19 && PlayBoard.playBoard[i][j - 3] == 0
                ...
                try {
                    if (PlayBoard.playBoard[i][j] == PlayBoard.UserC) {
                        ...
                        if (myCount == 3) { // 세번연속일때
                            ...
                            if (j + 3 < 19 && (PlayBoard.playBoard[i][j + 1] == 0 && PlayBoard.playBoard[i][j + 2] == 0
                                    && PlayBoard.playBoard[i][j + 3] == PlayBoard.UserC)) { // [111]001 right
                                ...
                                add += 2;
                                    ...
                                    && (PlayBoard.playBoard[i][j - 3] == 0 && PlayBoard.playBoard[i][j - 4] == 0
                                            && PlayBoard.playBoard[i][j - 5] == PlayBoard.UserC)) { // 100[111] left
                ...
                if (PlayBoard.playBoard[i][j] == PlayBoard.UserC) {
                    ...
                    if (myCount == 2) {
                        ...
                        try {
                            ...
                            if (j + 4 < 19 && PlayBoard.playBoard[i][j + 1] == 0 && PlayBoard.playBoard[i][j + 2] == 0
                                    && PlayBoard.playBoard[i][j + 3] == PlayBoard.UserC
                                    && PlayBoard.playBoard[i][j + 4] == PlayBoard.UserC) { // [11]0011 right
                                superWeight[i][j + 1] += 40;
                                superWeight[i][j + 2] += 40;
                                add += 2;
                            } /*
                               * else if (j - 5 > 0 && PlayBoard.playBoard[i][j - 2] == 0 &&
                               * PlayBoard.playBoard[i][j - 3] == 0 && PlayBoard.playBoard[i][j - 4] ==
                               * PlayBoard.UserC && PlayBoard.playBoard[i][j - 5] == PlayBoard.UserC) { //
                               * 1100[11] left
                               * superWeight[i][j - 2] += 40; superWeight[i][j - 3] += 40; add += 2; }
                               */ else if (j - 2 > 0 && j + 3 > 19 && PlayBoard.playBoard[i][j - 2] == 0
                                    && PlayBoard.playBoard[i][j + 1] == 0
                                    && PlayBoard.playBoard[i][j + 2] == PlayBoard.UserC
                                    && PlayBoard.playBoard[i][j + 3] == PlayBoard.UserC) { // 0[11]011 mid
                                superWeight[i][j - 2] += 40;
                                superWeight[i][j + 1] += 40;
                                add += 2;
                            } /*
                               * else if (j - 5 > 0 && PlayBoard.playBoard[i][j - 2] == 0 &&
                               * PlayBoard.playBoard[i][j - 5] == 0 && PlayBoard.playBoard[i][j - 3] ==
                               * PlayBoard.UserC && PlayBoard.playBoard[i][j - 4] == PlayBoard.UserC) { //
                               * 0110[11] left
                               * superWeight[i][j - 2] += 40; superWeight[i][j - 5] += 40; add += 2; }
                               */ else if (j - 5 > 0 && PlayBoard.playBoard[i][j - 2] == 0
                                    && PlayBoard.playBoard[i][j - 4] == 0
                                    && PlayBoard.playBoard[i][j - 3] == PlayBoard.UserC
                                    && PlayBoard.playBoard[i][j - 5] == PlayBoard.UserC) { // 1010[11] left
                                superWeight[i][j - 2] += 40;
                                superWeight[i][j - 4] += 40;
                                add += 2;
                            } else if (j - 3 > 0 && j + 2 < 19 && PlayBoard.playBoard[i][j - 2] == 0
                                    && PlayBoard.playBoard[i][j + 1] == 0
                                    && PlayBoard.playBoard[i][j - 3] == PlayBoard.UserC
                                    && PlayBoard.playBoard[i][j + 2] == PlayBoard.UserC) { // 10[11]01 mid
                                superWeight[i][j - 2] += 40;
                                superWeight[i][j + 1] += 40;
                                add += 2;
                            } else if (j + 4 < 19 && PlayBoard.playBoard[i][j + 1] == 0
                                    && PlayBoard.playBoard[i][j + 3] == 0
                                    && PlayBoard.playBoard[i][j + 2] == PlayBoard.UserC
                                    && PlayBoard.playBoard[i][j + 4] == PlayBoard.UserC) { // [11]0101 right
                                superWeight[i][j + 3] += 40;
                                superWeight[i][j + 1] += 40;
                                add += 2;
                            } else if (j + 4 < 19 && PlayBoard.playBoard[i][j + 1] == 0
                                    && PlayBoard.playBoard[i][j + 4] == 0
                                    && PlayBoard.playBoard[i][j + 2] == PlayBoard.UserC
                                    && PlayBoard.playBoard[i][j + 3] == PlayBoard.UserC) { // [11]0110 right
                                superWeight[i][j + 4] += 40;
                                superWeight[i][j + 1] += 40;
                                add += 2;
                            } /*
            ...
            for (int i = 0; i < 19; i++) {
                try {
                    if (PlayBoard.playBoard[i][j] == PlayBoard.UserC) {
                        ...
                        if (myCount == 3) {
                            if (i + 3 < 19 && PlayBoard.playBoard[i + 1][j] == 0 && PlayBoard.playBoard[i + 2][j] == 0
                                    && PlayBoard.playBoard[i + 3][j] == PlayBoard.UserC) { // [111]001 right
                                superWeight[i + 1][j] += 40;
                                superWeight[i + 2][j] += 40;
                                add += 2;
                            } else if (i - 5 > 0 && PlayBoard.playBoard[i - 3][j] == 0
                                    && PlayBoard.playBoard[i - 4][j] == 0
                                    && PlayBoard.playBoard[i - 5][j] == PlayBoard.UserC) {// 100[111] left
                                ...
                                add += 2;
                                    ...
                                    && PlayBoard.playBoard[i + 1][j] == 0
                                    && PlayBoard.playBoard[i + 2][j] == PlayBoard.UserC) { // 0[111]01 mid
                                superWeight[i - 3][j] += 40;
                                superWeight[i + 2][j] += 40;
                                add += 2;
                            } else if (i - 4 > 0 && i + 1 < 19 && PlayBoard.playBoard[i - 3][j] == 0
                ...
                try {
                    if (PlayBoard.playBoard[i][j] == PlayBoard.UserC) {
                        ...
                        if (myCount == 2) {
                            if (i + 4 < 19 && PlayBoard.playBoard[i + 1][j] == 0 && PlayBoard.playBoard[i + 2][j] == 0
                                    && PlayBoard.playBoard[i + 3][j] == PlayBoard.UserC
                                    && PlayBoard.playBoard[i + 4][j] == PlayBoard.UserC) { // [11]0011 (right)
                                superWeight[i + 1][j] += 40;
                                superWeight[i + 2][j] += 40;
                                add += 2;
                            }
                             ...
                             * else if (i - 5 > 0 && PlayBoard.playBoard[i - 2][j] == 0 &&
                             * PlayBoard.playBoard[i - 3][j] == 0 && PlayBoard.playBoard[i - 4][j] ==
                             * PlayBoard.UserC && PlayBoard.playBoard[i - 5][j] == PlayBoard.UserC) { //
                             * 1100[11] left
                             * // same as above superWeight[i - 2][j] += 40; superWeight[i - 3][j] += 40;
                             * add += 2; }
                             */
                                    ...
                                    && PlayBoard.playBoard[i + 1][j] == 0
                                    && PlayBoard.playBoard[i + 2][j] == PlayBoard.UserC
                                    && PlayBoard.playBoard[i + 3][j] == PlayBoard.UserC) { // 0[11]011 (mid)
                                superWeight[i - 2][j] += 40;
                                superWeight[i + 1][j] += 40;
                                add += 2;
                            }
                             ...
                             * else if (i - 5 > 0 && PlayBoard.playBoard[i - 2][j] == 0 &&
                             * PlayBoard.playBoard[i - 5][j] == 0 && PlayBoard.playBoard[i - 3][j] ==
                             * PlayBoard.UserC && PlayBoard.playBoard[i - 4][j] == PlayBoard.UserC) { //
                             * 0110[11] (left)
                             * // same as above superWeight[i - 2][j] += 40; superWeight[i - 5][j] += 40;
                             * add += 2; }
                             */
                                    ...
                                    && PlayBoard.playBoard[i - 4][j] == 0
                                    && PlayBoard.playBoard[i - 3][j] == PlayBoard.UserC
                                    && PlayBoard.playBoard[i - 5][j] == PlayBoard.UserC) { // 1010[11] (left)
                                superWeight[i - 2][j] += 40;
                                superWeight[i - 4][j] += 40;
                                add += 2;
                            }
                                    ...
                                    && PlayBoard.playBoard[i + 1][j] == 0
                                    && PlayBoard.playBoard[i - 3][j] == PlayBoard.UserC
                                    && PlayBoard.playBoard[i + 2][j] == PlayBoard.UserC) { // 10[11]01 mid
                                superWeight[i - 2][j] += 40;
                                superWeight[i + 1][j] += 40;
                                add += 2;
                            }
                                    ...
                                    && PlayBoard.playBoard[i + 3][j] == 0
                                    && PlayBoard.playBoard[i + 2][j] == PlayBoard.UserC
                                    && PlayBoard.playBoard[i + 4][j] == PlayBoard.UserC) { // [11]0101 (right)
                                superWeight[i + 3][j] += 40;
                                superWeight[i + 1][j] += 40;
                                add += 2;
                            }
                                    ...
                                    && PlayBoard.playBoard[i + 4][j] == 0
                                    && PlayBoard.playBoard[i + 2][j] == PlayBoard.UserC
                                    && PlayBoard.playBoard[i + 3][j] == PlayBoard.UserC) { // [11]0110 (right)
                                superWeight[i + 4][j] += 40;
                                superWeight[i + 1][j] += 40;
                                add += 2;
                            }
